(function () {
    ...
    */
     ...
     */
    function sizeHighlightCell(highlight, bounds) {
    ...
    */    
     ...
     */
    class GDTransferDragHandler extends GDDragHandler {
        constructor(at) {
            super(at);
            this._started = false;
        }
     ...
     */
    class GDFileDragHandler extends GDDragHandler {
        constructor(at) {
            super(at);
    ...
    class GDHoriontalAlignmentGuide extends GDAlignmentGuide {
        get isHorizontal() {
            return true;
        }
    ...
    class GDHorizontalEdgeAlignmentGuide extends GDHoriontalAlignmentGuide {

    }

    class GDHorizontalMarginAlignmentGuide extends GDHoriontalAlignmentGuide {

    }

    class GDVerticalMarginAlignmentGuide extends GDVerticalAlignmentGuide {

    }

    class GDHorizontalPaddingAlignmentGuide extends GDHoriontalAlignmentGuide {

    }

    class GDVerticalPaddingAlignmentGuide extends GDVerticalAlignmentGuide {

    }

    class GDHorizontalCenterAlignmentGuide extends GDHoriontalAlignmentGuide {

    }

    class GDVerticalCenterAlignmentGuide extends GDVerticalAlignmentGuide {
    ...
    class GDTopRightHandle extends GDHandle {
        calculateStartDifference(tool, x, y) {
            let ownerBounds = tool.guideCoordinator.cachedBoundsForCell(this.owner);
    ...
    class GDRightCenterHandle extends GDHandle {
        calculateStartDifference(tool, x, y) {
            let ownerBounds = tool.guideCoordinator.cachedBoundsForCell(this.owner);
        ...
        dragged(tool, x, y) {
            ...
            if (constrained) {
                ...
                let oldHeight = this.owner.getProperty("height");            const newHeight = (tool.originalBounds.height / tool.originalBounds.width) * width;
    ...
    class GDLeftCenterHandle extends GDHandle {
        calculateStartDifference(tool, x, y) {
            let ownerBounds = tool.guideCoordinator.cachedBoundsForCell(this.owner);
    ...
    class GDLeftTopHandle extends GDHandle {
        calculateStartDifference(tool, x, y) {
            let ownerBounds = tool.guideCoordinator.cachedBoundsForCell(this.owner);
    ...
    class GDBottomLeftHandle extends GDHandle {
        calculateStartDifference(tool, x, y) {
            let ownerBounds = tool.guideCoordinator.cachedBoundsForCell(this.owner);
        ...
        dragged(tool, x, y) {
            ...
            const oldWidth = width;
            const oldHeight = height;
            let dy = y - (ownerBounds.top + ownerBounds.height);        let dx = ownerBounds.left - x;
     ...
     * @param {GDWidgetInstanceCell} cell 
     */
    function handlesForCell(cell, at) {
    ...
    */
    ...
    class GDCenterGuideCreator extends GDGuideCreator {
        guidesForContainer(container) {
            const bounds = this.guideCoordinator.cachedBoundsForCell(container);
    ...
    class GDPaddingGuideCreator extends GDGuideCreator {
        guidesForContainer(container) {
            const bounds = this.guideCoordinator.cachedBoundsForCell(container);
    ...
    class GDMarginGuideCreator extends GDGuideCreator {
        guidesForContainer(container) {
            const bounds = this.guideCoordinator.cachedBoundsForCell(container);
            const computedStyles = getComputedStyle(container.DOMElement);
    ...
    */
     ...
     * is open. 
     */
    class GDNOPTool extends GDTool {
        mouseDown() {
        }
    ...
    class GDNativeTextTool extends GDTextTool {
        editTextOfFigure(f) {
